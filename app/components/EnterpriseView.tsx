...
const copy = {
  en: {
    ...
    webText: "Scan a one-time QR with GrantTap on iPhone. The browser receives approval-only access and stores computer links inside a locally encrypted vault.",
    ...
    nowItems: ["Signed endpoint policy", "Device identity + protected receipt storage", "Deny-wins provider enforcement", "QR-first browser approvals"],
    laterItems: ["Organization admin console", "SAML/OIDC SSO and SCIM", "Device inventory and remote revocation refresh", "Encrypted enterprise audit delivery and compliance exports"],
  ...
  ru: {
    ...
    webText: "Сканируйте одноразовый QR приложением GrantTap на iPhone. Браузер получает только approvals, а ссылки компьютеров хранит в локально зашифрованном vault.",
    ...
    nowItems: ["Подписанная endpoint policy", "Device identity и защищённое хранение receipt", "Deny-wins enforcement у providers", "QR-first approvals в браузере"],
    laterItems: ["Админ-консоль организации", "SAML/OIDC SSO и SCIM", "Инвентарь устройств и онлайн-отзыв", "Зашифрованный Enterprise-аудит и compliance exports"],
