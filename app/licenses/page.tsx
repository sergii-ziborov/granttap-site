    ...
    <LegalPage
      ...
      sections={{
        en: [
          ...
          { heading: "Trademarks", paragraphs: ["Apple, Apple Watch, iPhone, and App Store are trademarks of Apple Inc. Claude and Claude Code are trademarks of Anthropic. OpenAI and Codex are trademarks of OpenAI. All other names belong to their respective owners."] },
        ],
        ru: [
          ...
          { heading: "Товарные знаки", paragraphs: ["Apple, Apple Watch, iPhone и App Store являются товарными знаками Apple Inc. Claude и Claude Code принадлежат Anthropic. OpenAI и Codex принадлежат OpenAI. Остальные названия принадлежат соответствующим владельцам."] },
        ],
      }}
    />
  );
