...
export const copy = {
  en: {
    nav: ["How it works", "Product", "Security", "Enterprise", "Connect"],
    status: "Open account",
    ...
    accountKicker: "GrantTap Web",
    accountTitle: "Scan with iPhone. Approve from any browser.",
    accountText: "A one-time QR grants this browser approval-only access. Phone and computer pairing keys never enter the browser.",
    accountAction: "Open QR sign-in",
    enterpriseKicker: "For managed endpoints",
    enterpriseTitle: "Organization policy that the endpoint enforces.",
    enterpriseText: "Device-bound login receipts and signed policy fail closed before an agent approval can widen access.",
    enterpriseAction: "Explore Enterprise",
  ...
  ru: {
    nav: ["Как работает", "Приложение", "Безопасность", "Enterprise", "Подключить"],
    status: "Войти",
    enterprise: "Enterprise",
    account: "Аккаунт",
    ...
    accountKicker: "GrantTap Web",
    accountTitle: "Сканируйте iPhone — подтверждайте из браузера.",
    accountText: "Одноразовый QR даёт браузеру только доступ к подтверждениям. Ключи пейринга телефона и компьютера в браузер не передаются.",
    accountAction: "Открыть QR-вход",
    enterpriseKicker: "Для управляемых endpoints",
    enterpriseTitle: "Политика организации, которую исполняет сам endpoint.",
    enterpriseText: "Привязанный к устройству login receipt и подписанная политика закрывают доступ до того, как подтверждение агента сможет его расширить.",
    enterpriseAction: "Открыть Enterprise",
