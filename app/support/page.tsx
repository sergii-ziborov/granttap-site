...
export default function SupportPage() {
  return <LegalPage
    ...
    sections={{
      en: [
        { heading: "Connect a computer", bullets: ["Install Node.js 22 or newer.", "Run npm install -g granttap-mcp.", "Run granttap setup. It detects providers, installs supported hooks, and starts or repairs the helper.", "Authenticate in Cursor, Codex, Claude Code, or Grok Build. The browser opens granttap.com/connect — Approve this coding app, Reconnect, or Add another. Scan in GrantTap only when a new device joins.", "A saved pairing still opens that page. It does not skip to the coding-app callback.", "Use granttap status for a read-only readiness summary."] },
      ...
      ru: [
        { heading: "Подключить компьютер", bullets: ["Установите Node.js 22 или новее.", "Выполните npm install -g granttap-mcp.", "Выполните granttap setup. Команда найдёт providers, установит hooks и запустит или исправит helper.", "Authenticate в Cursor, Codex, Claude Code или Grok Build. Браузер открывает granttap.com/connect — Approve, Reconnect или Add another. Скан в GrantTap только для нового устройства.", "Сохранённое сопряжение всё равно открывает эту страницу и не прыгает сразу в коллбек.", "granttap status показывает read-only readiness summary."] },
