        ...
        en: [
          ...
          },
          {
            ...
            bullets: [
              ...
              "Confirm the intended Codex or Claude Code integration is configured and the local helper is running.",
        ...
        ru: [
          ...
          },
          {
            ...
            bullets: [
              ...
              "Убедитесь, что нужная интеграция Codex или Claude Code настроена, а локальный помощник работает.",
