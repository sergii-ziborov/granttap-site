        ...
        en: [
          ...
          },
          {
            ...
            bullets: [
              ...
              "GrantTap account login is optional for Personal/Team and required for managed Enterprise. Run granttap login, scan its one-time QR, then run granttap login --complete. Use granttap relogin or granttap logout without changing phone pairing.",
        ...
        ru: [
          ...
          },
          {
            ...
            bullets: [
              ...
              "Вход в GrantTap необязателен для Personal/Team и обязателен для управляемого Enterprise. Выполните granttap login, отсканируйте одноразовый QR, затем granttap login --complete. Команды granttap relogin и granttap logout не меняют пейринг телефона.",
